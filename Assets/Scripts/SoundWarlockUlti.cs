...
public class SoundWarlockUlti : Sound
{
	public SoundWarlockUlti(SkillActiveData skillData, float volume = 1f)
	{
	...
	public override void Play(SoundType type, string by, bool isVoice, float priority, SoundManager soundManager)
	{
		...
		soundManager.PlayLooped(type, by, priority, this.volume, soundManager.warlockUltiLoop, time - 0.5f, time, time2, time2 + 0.5f);
	}
