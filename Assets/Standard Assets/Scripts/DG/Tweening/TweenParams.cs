...
namespace DG.Tweening
{
	public class TweenParams
	{
		...
		{
			this.easeType = ease;
			this.easeOvershootOrAmplitude = ((overshootOrAmplitude == null) ? DOTween.defaultEaseOvershootOrAmplitude : overshootOrAmplitude.Value);
			this.easePeriod = ((period == null) ? DOTween.defaultEasePeriod : period.Value);
			this.customEase = null;
			return this;
		}
