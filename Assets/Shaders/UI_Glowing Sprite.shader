  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = float3((((-u_xlat16_0.xyz) * in_f.color.xyz) + in_f.color.xyz));
          u_xlat0_d = (u_xlat16_0 * in_f.color);
          u_xlat0_d.xyz = float3(((float3(_EffectAmount, _EffectAmount, _EffectAmount) * u_xlat16_1.xyz) + u_xlat0_d.xyz));
