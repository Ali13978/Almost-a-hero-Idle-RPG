  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = float3(((-u_xlat10_0.xyz) + float3(1, 1, 1)));
          u_xlat1_d.xyz = float3((u_xlat16_1.xyz * _Black.xyz));
          u_xlat1_d.xyz = float3((u_xlat10_0.www * u_xlat1_d.xyz));
          u_xlat1_d.xyz = float3((u_xlat1_d.xyz * _Color.www));
          u_xlat1_d.xyz = float3((u_xlat1_d.xyz * in_f.color.www));
          u_xlat1_d.w = 0;
          out_f.color = ((u_xlat10_0 * in_f.color) + u_xlat1_d);
          return out_f;
      }
